...
export function useKnowledgeBase() {
  ...
  const getKnowledgeBaseById = useCallback(async (id: string) => {
    if (!user?.id) {
  ...
  const updateKnowledgeBase = useCallback(async (id: string, knowledgeBase: Partial<KnowledgeBase>) => {
